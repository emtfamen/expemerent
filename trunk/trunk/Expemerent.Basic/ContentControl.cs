...
{
    public class ContentControl : SciterControl
    {
        ...
        protected override void OnLoad(EventArgs args)
        {
            ...
            body.ScriptingMethodCall += (s, e) => { e.ReturnValue = "CSS Method:" + e.MethodName; };
            body.MethodCall += (s, e) => { MessageBox.Show("MethodCall"); };

            SciterControls.Add(body);
            LoadHtmlResource<MainForm>("Html/highlight-links.htm");
        }
