 ...
 **/
    ...
    struct notification_handler
  {
      ...
      virtual LRESULT on_load_data(LPSCN_LOAD_DATA pnmld)
        ...
        if(load_resource_data(static_cast< BASE* >(this)->get_resource_instance(), pnmld->uri, pb, cb))
	...
	inline bool load_html_resource(HINSTANCE hinst, UINT resId, LPCBYTE& pb, DWORD& cb )
	{
